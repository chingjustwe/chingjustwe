...
<p>
  <img src="assets/badge-coding.svg" height="34" alt="Coding" />&nbsp;
  <img src="assets/badge-ai.svg" height="34" alt="Playing with AI" />&nbsp;
  <img src="assets/badge-open.svg" height="34" alt="Open to cool stuff" />&nbsp;
...
<table>
  <tr>
    <td width="33%" valign="top" align="center">
      <img src="assets/project-llm-interceptor.svg" width="100%" alt="LLM Interceptor dashboard" />
      <h3>🛡️ LLM Interceptor</h3>
      <p><sub>Peek under the hood of every LLM call. Like a firewall, but for your prompts.</sub></p>
      <p><code>Go</code> · <code>Bytecode</code> · <code>Guardrails</code></p>
      <p><a href="https://chingjustwe.github.io/llm-interceptor/">→ live demo</a></p>
    </td>
    <td width="33%" valign="top" align="center">
    ...
    <td width="33%" valign="top" align="center">
      <img src="assets/project-agent-forge.svg" width="100%" alt="Agent Forge pipeline" />
      <h3>🤖 Agent Forge</h3>
      <p><sub>Agents that don't misbehave in production. Gateway bouncer → guardrail harness → runtime, with observability side-eyeing every step.</sub></p>
      <p><code>Python</code> · <code>Gateway</code> · <code>Observability</code></p>
      <p><a href="https://chingjustwe.github.io/agent-forge/">→ live demo</a></p>
    </td>
  </tr>
</table>
...
[![GitHub](https://img.shields.io/badge/GitHub-chingjustwe-181717?logo=github&logoColor=white&style=flat-square)](https://github.com/chingjustwe)
[![Blog](https://img.shields.io/badge/Blog-chingjustwe.github.io-39d3ff?style=flat-square)](https://chingjustwe.github.io/)
[![LinkedIn](https://img.shields.io/badge/LinkedIn-Rocky_Chi-0A66C2?logo=linkedin&logoColor=white&style=flat-square)](https://www.linkedin.com/in/rocky-chi-302633103/)
[![Email](https://img.shields.io/badge/Email-chingjustwe@live.com-EA4335?logo=gmail&logoColor=white&style=flat-square)](mailto:chingjustwe@live.com)
[![Location](https://img.shields.io/badge/Location-Hangzhou-ffd166?style=flat-square)](#)

---

<p align="center">
  <sub>© 2026 Rocky Chi · Built with too much coffee and a stubborn SVG.</sub>
</p>
